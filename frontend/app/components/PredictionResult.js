            ...
            <div className="modal glass-panel" onClick={(e) => e.stopPropagation()} style={{
                ...
                <div style={{
                    ...
                    <h2 style={{
                        ...
                        {result.prediccion === 'Leve' ? t('mild') : result.prediccion === 'Moderada' ? t('moderate') : t('severe')}
                    </h2>
                    ...
                    <div style={{
                        ...
                        <span style={{ fontSize: '1rem', fontWeight: '600', color: 'var(--text-muted)' }}>% {t('confidenceField')}</span>
                    </div>
                </div>
                            ...
                            <div className="confidence-item" key={key} style={{ marginBottom: 0 }}>
                                <div className="confidence-label" style={{ marginBottom: '0.4rem', justifyContent: 'space-between', display: 'flex' }}>
                                    <span style={{ fontSize: '0.85rem', fontWeight: '600', color: 'var(--text-secondary)' }}>
                                        {key === 'leve' ? t('mild') : key === 'moderada' ? t('moderate') : t('severe')}
                                    </span>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.75rem' }}>
                            {result.factores.map((f, i) => (
                                <div key={i} style={{
                                    ...
                                    <span>{typeof f === 'string' ? translateValue(f) : (t(f.key) + (f.val ? ` ${f.val}` : ''))}</span>
                                </div>
                            ))}
                        </div>
                    </div>
